...
/**
 * @file
 * Lewis College of Human Sciences Adaptivetheme subtheme override implementation to display a single Drupal page.
 * For Lewis College Homepage Only
 *
 * ###  Full Width Wrappers  ###
 *
 ...
 *
 * Custom Regions:
 * - $page['iit_global_header']: full width region for IIT Global Header Block
 * - $page['iit_global_footer']: full width region for IIT Global Footer
 *
