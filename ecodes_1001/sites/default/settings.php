 ...
 */
$db_url = 'mysqli://csep-test:Ethics$12@myst-my-p.cns.iit.edu/csep_eecodes-test';
$db_prefix = '';
 ...
 * for you.
 */
$base_url = 'http://ethics-t.iit.edu/ecodes';  // NO trailing slash!
...
$databases = array (
  ...
  array (
    ...
    array (
      'driver' => 'mysql',
      'database' => 'eethics_codes',
      'username' => 'csep',
      'password' => 'ec1976!',
      'host' => 'myst-my-p.cns.iit.edu',
      'port' => '',
      'prefix' => '',
    ),
  ),
);
$drupal_hash_salt = file_get_contents('/home/ethics/public_html/ecodes/sites/default/files/salt.txt');