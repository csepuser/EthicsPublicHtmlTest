...
<div class="main-container">
  <div id="page">
	...
	<tr>
	  ...
	  <td align="right">
	    <table width ="100%" style="float:left; margin-top: 40px;">
	      <tr>
		<td style="padding-right :80px;" width="60%">
		  <?php if(arg(0) != "search-codes"): ?>
  ...
  <div id="footer">
    <?php print $footer ?>
    <a class="no-style" href="http://ethics.iit.edu" target="_blank"><img width="30" src="/ecodes/iit_logo.gif" alt="IIT"></a> <span style="position: relative; bottom: 7px;">Center for the Study of Ethics in the Professions at IIT. &copy; 2014 | <a href="/ecodes/user">Admin Login</a> | <a href="/ecodes/sitemap">Site Map</a> </span>
    <?php 
